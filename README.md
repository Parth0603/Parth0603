...
<p align="center">
  <img src="https://raw.githubusercontent.com/Parth0603/Parth0603/output/github-contribution-grid-snake.svg" alt="GitHub Contribution Grid Snake" width="100%" />
</p>
...
<table border="0" width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li><b>HiveMate Platform:</b> Production startup networking ecosystem.</li>
        <li><b>SYNAPSE System:</b> Decentralized hackathon infrastructure.</li>
        <li><b>AI Portfolio Engine:</b> Automated resume-to-web deployment microservice.</li>
        <li><b>Crypto Alert Matrix:</b> Low-latency network telemetry pipeline.</li>
        <li><b>Real Estate Engine:</b> Performant asset discovery marketplace.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>Milestones</h3>
      <ul>
        <li><b>Top 10 Finalist:</b> East India Blockchain Summit (EIBS) 2.0.</li>
        <li><b>Engineering Growth:</b> Accelerated track from Founding Intern to Software Engineer at HiveMate.</li>
        <li><b>Ecosystem Execution:</b> Lead Organizer for SYNAPSE Blockchain Hackathon.</li>
      </ul>
    </td>
  </tr>
</table>
